...
void loop()
{
   ...
   if (distance1 < distancia3 && distancia2 < distance1)
    {
       digitalWrite(led1, HIGH);
       digitalWrite(led2, HIGH);
       digitalWrite(led3, HIGH); 
       for (int thisNote = 7; thisNote < 12; thisNote++) {
   ...
   if (distance1 < distancia4 && distancia3 < distance1)
    {
       digitalWrite(led1, HIGH);
       digitalWrite(led2, HIGH);
       digitalWrite(led3, HIGH); 
       for (int thisNote = 13; thisNote < 19 ; thisNote++) {
   ...
   delay(50);
    ...
    if (distance1 < distancia5 && distancia4 < distance1)
    {
       digitalWrite(led1, HIGH);
       digitalWrite(led2, HIGH);
       digitalWrite(led3, HIGH); 
       for (int thisNote = 20; thisNote < 26; thisNote++) {
